...
import translations from './SignUp.json';
  ...
  return (
   ...
   <div className="login-logo " >
            ...
            <form className="login-form" >
              <h1 className="h3  fw-normal text-light">{t("pleaseSignUp")}</h1>
              <div
                className={`my-1 form-floating ${
              ...
              >
                <input
                  ...
                  onChange={(e) => {
                    ...
                    {  
                        setError("confirm and paswort should be identiical");
                    }else
                    {
                ...
                />
                 <label htmlFor="floatingPassword" className="label-login">confirm Passwort</label>
                {error && !confirm && (
                  <div className="error_msg">
                    {t("confirmRequired")}
                  </div>
